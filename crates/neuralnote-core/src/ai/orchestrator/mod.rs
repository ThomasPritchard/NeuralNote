...
mod context_budget;
use context_budget::fit_prompt_to_window;
mod citations;
mod history;
use citations::extract_cited_ids;
use history::{prepare_final_answer_messages, prepare_history};
mod settlement;
use settlement::{
